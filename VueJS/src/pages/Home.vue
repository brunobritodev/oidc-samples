          ...
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a
                  class="nav-link"
                  @click="callApi('User/checkUsername?username=aeouaoeu')"
                  href="#"
                >Call unsecure Api</a>
              </li>
              <li class="nav-item">
                <a
                  class="nav-link"
                  @click="callApi('management/user-data')"
                  href="#"
                >Call secure Api</a>
              </li>
            </ul>
            ...
            <ul class="nav flex-column mb-2">
              <li class="nav-item">
                <a class="nav-link" href="#/admin">Administrator only</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#/freeuser">Logged User</a>
              </li>
            </ul>
          </div>
        </nav>
...
export default {
  ...
  methods: {
    async callApi(api) {
      let self = this;
      let result = await this.api.get(api);
      self.logApi(result);
    },
    getToken() {
      let self = this;
